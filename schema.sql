...
-- ----------------------------------------------------------------------------
-- When a visitor clicks "Request" on a downloadable resource (company profile,
-- certifications, design guidelines), they fill a short form. We capture the
-- contact info + which resource, then fulfil it manually during office hours.
